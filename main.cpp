...
int main()
{
    ...
    unifiedShader.setVec3("uLightColor1", 5, 5,5);

    unifiedShader.setVec3("uLightPos2", 0, 100, 20);
    unifiedShader.setVec3("uLightColor2", 5, 5, 5);

    // Donji uglovi
    unifiedShader.setVec3("uLightPos3", 100, -20, -30);
    unifiedShader.setVec3("uLightColor3", 5, 5, 5);

    unifiedShader.setVec3("uLightPos4", 0, 0, 50);
    unifiedShader.setVec3("uLightColor4", 5, 5, 5);

    unifiedShader.setVec3("uViewPos", 0, 0, 5);

    glm::mat4 projection = glm::perspective(glm::radians(45.0f), (float)screenWidth / (float)screenHeight, 0.1f, 100.0f);
    unifiedShader.setMat4("uP", projection);
    glm::mat4 view = glm::lookAt(glm::vec3(0.0f, 50.0f, -75.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
